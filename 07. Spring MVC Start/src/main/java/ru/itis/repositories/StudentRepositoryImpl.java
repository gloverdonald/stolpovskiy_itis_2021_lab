...
public class StudentRepositoryImpl implements StudentRepository {
    ...
    //language=SQL
    private static final String SQL_INSERT = "insert into student(first_name, last_name, group_name, date_of_birth) " +
            "values (:firstName, :lastName, :groupName,:dateOfBirth)";
