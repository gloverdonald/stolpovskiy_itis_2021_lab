...
public class AuthorsController {
    ...
    @GetMapping
    public ResponseEntity<AuthorsPage> getAuthors(@Parameter(description = "Номер страницы")
    ...
    public ResponseEntity<PostResponse> addAuthorPost(@Parameter(description = "Id автора")
    ...
    public ResponseEntity<PostResponse> updateAuthorPost(@Parameter(description = "Id поста")
                                                         @PathVariable("post-id") Long postId,
